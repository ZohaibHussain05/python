...
def test_div(): # name of test function (test case) should start with 'test_'
    assert div(4, 2) == 2
...
def test_open():
    ...
    try: 
        openfile(filename) 
        raise AssertionError("Expected exception not thrown.") # Expect a exception from the function
